...
class AbstractScreen:
    ...
    def __init__(self, parent, ui):
        ...
        self.parent = parent   # For main screens, this is root
        self.toplevels: dict[int, AbstractScreen] = {}   # key: id(screen) generated by builtin function id
        self._on_destroy_callback: Callable[[], Any] | None = None

        self.frame = tk.Frame(parent)    # Always operate on this only
        self.frame.pack()
